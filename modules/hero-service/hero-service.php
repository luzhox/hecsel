...
<img src="<?php the_sub_field('background_mob')?>" alt="" class="hide-tablet-on-up">
    <div class="container">
    ...
    <img src="<?php the_sub_field('background_desktop')?>" alt="" class="hide-on-medium-only">
    <div class="hero-hecsel__down">
